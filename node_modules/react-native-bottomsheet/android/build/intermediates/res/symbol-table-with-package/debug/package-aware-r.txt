...
anim bs_list_item_in
anim bs_list_layout_anim_in
...
anim dock_bottom_enter
anim dock_bottom_exit
...
attr bs_bottomSheetStyle
attr bs_closeDrawable
attr bs_collapseListIcons
attr bs_dialogBackground
attr bs_dividerColor
attr bs_gridItemLayout
attr bs_gridItemTitleTextAppearance
attr bs_headerLayout
attr bs_listItemLayout
attr bs_listItemTitleTextAppearance
attr bs_listStyle
attr bs_moreDrawable
attr bs_moreText
attr bs_numColumns
attr bs_titleTextAppearance
...
color bs_dark_divider_color
color bs_divider_color
...
dimen bs_grid_bottom_padding
dimen bs_grid_left_padding
dimen bs_grid_right_padding
dimen bs_grid_top_padding
...
drawable bs_ic_clear
drawable bs_ic_clear_light
drawable bs_ic_more
drawable bs_ic_more_light
drawable bs_list_dark_selector
drawable bs_list_selector
...
id blocking
id bottom
id bottom_sheet_gridview
id bottom_sheet_title
id bottom_sheet_title_image
id bs_list_image
id bs_list_title
id bs_main
id bs_more
...
integer bs_grid_colum
integer bs_initial_grid_row
integer bs_initial_list_row
...
layout bs_grid_entry
layout bs_header
layout bs_list_divider
layout bs_list_entry
...
style BottomSheet
style BottomSheet_Animation
style BottomSheet_Dialog
style BottomSheet_Dialog_Dark
style BottomSheet_Grid
style BottomSheet_GridItem
style BottomSheet_GridItemImage
style BottomSheet_GridItemTitle
style BottomSheet_Icon
style BottomSheet_List
style BottomSheet_ListDivider
style BottomSheet_ListItem
style BottomSheet_ListItemImage
style BottomSheet_ListItemTitle
style BottomSheet_List_Dark
style BottomSheet_Title
style BottomSheet_TopDivider
...
styleable BottomSheet bs_bottomSheetStyle bs_closeDrawable bs_collapseListIcons bs_dialogBackground bs_dividerColor bs_gridItemLayout bs_gridItemTitleTextAppearance bs_headerLayout bs_listItemLayout bs_listItemTitleTextAppearance bs_listStyle bs_moreDrawable bs_moreText bs_numColumns bs_titleTextAppearance
