    ...
    return (
      <View style={[styles.container, containerStyle]}>
        ...
        <View style={[styles.headerContainer, { backgroundColor: this.state.color,justifyContent:'space-between' }, headerContainerStyle]}>
          <TouchableOpacity onPress={() => goBackFunc? goBackFunc(): navigation.goBack()} style={[styles.backButton, { display: backButton ? 'flex' : 'none', height: backButton ? '100%' : 30, opacity: backButton ? 1 : 0 }]}>
       ...
       keyboardOpeningTime={Number.MAX_SAFE_INTEGER}
        ...
        <TouchableOpacity onPress={()=>modifiedFunc()}  style={{backgroundColor:'lightskyblue', padding:heightPercentageToDP(1.5),paddingHorizontal:heightPercentageToDP(4), alignSelf:'center', marginHorizontal:10,marginVertical:6, borderRadius:1000}}>
        ...
        showsVerticalScrollIndicator={false}
          ...
          contentContainerStyle={[scrollContainerStyle,{paddingBottom:heightPercentageToDP('2%')}]}
        ...
        >
          <View>
            <Animated.Text
              style={[
                styles.title,
                {opacity:this.state.isHeaderScrolled ? 0 : 1 },
                titleStyle,
                titleStyles,
                {
